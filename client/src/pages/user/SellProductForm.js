...
const CreateProduct = () => {
  ...
  // getAllCategory function should be defined first to avoid scope issues
  ...
  // Use useEffect to call the API and populate categories
  useEffect(() => {
    getAllCategory();
  }, []);
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <div className="m-auto w-75 p-4 border rounded shadow-sm bg-light">
              ...
              {/* Shipping Select */}
              <div className="mb-3">
                <label className="form-label">Sell to Reselify?</label>
                <Select
                  bordered={false}
